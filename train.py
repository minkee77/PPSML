...
parser.add_argument('--unlabel_num', type=int, default=10, help='the number of unlabeled samples')
parser.add_argument('--neighbor_k', type=int, default=3, help='the number of k-nearest neighbors')
parser.add_argument('--semi_neighbor_k', type=int, default=3, help='the number of k-nearest neighbors used in semi-supervised setting')
...
def train(train_loader, model, criterion, optimizer, epoch_index, F_txt):
	...
	for episode_index, (query_images, query_targets, support_images, support_targets, unlabel_images, unlabel_targets) in enumerate(train_loader):
